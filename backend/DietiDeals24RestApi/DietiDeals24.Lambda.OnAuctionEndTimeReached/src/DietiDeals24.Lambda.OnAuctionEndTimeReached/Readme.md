...
Execute unit tests
```
cd "DietiDeals24.Lambda.OnAuctionEndTimeReached/test/DietiDeals24.Lambda.OnAuctionEndTimeReached.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "DietiDeals24.Lambda.OnAuctionEndTimeReached/src/DietiDeals24.Lambda.OnAuctionEndTimeReached"
