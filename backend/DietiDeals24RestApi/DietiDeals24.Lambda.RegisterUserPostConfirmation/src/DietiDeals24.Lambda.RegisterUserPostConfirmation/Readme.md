...
Execute unit tests
```
cd "DietiDeals24.Lambda.RegisterUserPostConfirmation/test/DietiDeals24.Lambda.RegisterUserPostConfirmation.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "DietiDeals24.Lambda.RegisterUserPostConfirmation/src/DietiDeals24.Lambda.RegisterUserPostConfirmation"
